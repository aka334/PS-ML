...
features = df_low.drop(['Actual_Count', 'Flow_ID','Range_Class'], axis=1)
target = df_low['Actual_Count']
...
# Save the model
model.save('model1-10000.keras')  # Saves the model to a HDF5 file
joblib.dump(scaler, 'scaler1-10000.joblib')